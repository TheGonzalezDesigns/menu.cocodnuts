...
/***/ (function(module, exports, __webpack_require__) {
	...
	var file = __webpack_require__(327)(fileName);
	...
	var vm = new Vue({
		...
		methods: {
			disability: function disability() {
				var disability = this.name && this.category && this.price && this.photo && this.description ? false : true;
			...
			previewData: function previewData() {
				var showSubmitButton = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : true;
			...
			reviewData: function reviewData() {
				var searchForCopies = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : true;

				var data = this.getData();
				var check = this.checkData(searchForCopies);
				if (check.valid) {
					this.previewData();
				} else this.showErrors(check.why);
			},
			publishData: function publishData() {
				this.pushData();
				this.resetData(true);
				//this.updateFile();
			},
			checkData: function checkData() {
				...
				var priceRegExp = new RegExp("^\\d+(.\\d{1,2})?$", "g");
				var photoRegExp = new RegExp("^" +
				// protocol identifier
				"(?:(?:https?|ftp)://)" +
				...
				"(?:[/?#]\\S*)?" + "$", "i");
				if (searchForCopies) {
					if (this.menu.length) this.menu.forEach(function (item) {
						return item.name == _this.name ? instance++ : 0;
					});
					if (instance) {
						errors.push(instance + " item(s) with the same name already exist(s).");
						this.errorCodes[0]++;
					}
				}
			...
			resetData: function resetData() {
				var hardReset = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : false;
			...
			toggleBodyOverflow: function toggleBodyOverflow() {
				...
				document.body.className = (this.overflow ? "show" : "hide") + "Overflow";
			},
			redisable: function redisable() {
				this.resetData();
			...
			search: function search() {
				...
				var check = this.checksearch();
				if (check.valid) {
					this.data = this.menu.filter(function (item) {
						return item[_this2.searchCategory] == _this2.searchValue;
					});
					if (!this.data.length) {
			...
			checksearch: function checksearch() {
				...
				var priceRegExp = new RegExp("^\\d+(.\\d{1,2})?$", "g");
				this.resetErrors();
				if (this.searchCategory == "name" || this.searchCategory == "description" || this.searchCategory == "category") {
			...
			capatalize: function capatalize(text) {
			...
			switchSelection: function switchSelection(choice) {
			...
			republishData: function republishData() {
				this.deleteData();
				this.publishData();
				this.cancelData();
			},
			...
			updateFile: function updateFile() {
				...
				var data = JSON.stringify(file, null, 2);
				fs.writeFile(fileName, data, function (err) {
					if (err) return _this3._alert("Publish failed. Reload the page.", "is-danger");
					_this3._alert("Publish successful.", "successful");
				});
			},
			_alert: function _alert(message, type) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var map = {
		"./components.min": 328,
		"./components.min.js": 328,
		"./index": 326,
		"./index.js": 326,
		"./index.min": 330,
		"./index.min.js": 330,
		"./index.processed": 332,
		"./index.processed.js": 332,
		"./index.processed.min": 334,
		"./index.processed.min.js": 334
	};
...
/***/ (function(module, exports) {
	...
	Vue.component("page-head",{template:"#page-head"}),Vue.component("grid",{template:"#grid",props:["colors"]});
...
/***/ (function(module, exports) {
	...
	var app=new Vue({el:"#demo",mounted:function(){window.addEventListener("scroll",this.onScroll)},methods:{onScroll:function(e){window.innerHeight+window.pageYOffset>=document.body.offsetHeight&&this.addMoreColors()},addMoreColors:function(){this.colors=this.colors.concat([{hex:"#f6d258"},{hex:"#efcec5"},{hex:"#d1af94"},{hex:"#97d5e0"},{hex:"#f6d258"},{hex:"#efcec5"}])}},data:function(){return{colors:[{hex:"#f6d258"},{hex:"#efcec5"},{hex:"#d1af94"},{hex:"#97d5e0"},{hex:"#f6d258"},{hex:"#efcec5"},{hex:"#97d5e0"},{hex:"#f6d258"},{hex:"#efcec5"},{hex:"#d1af94"},{hex:"#97d5e0"}]}}});
...
/***/ (function(module, exports) {
	...
	/******/);
	//# sourceMappingURL=index.processed.js.map
